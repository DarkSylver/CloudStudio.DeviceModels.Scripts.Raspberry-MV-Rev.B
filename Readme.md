...
# Configuration Script – Raspberry - MV - Rev. B

This **Configuration** script is designed for the **Raspberry - MV** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – Raspberry - MV Rev. B

Este script de **Configuration** está diseñado para el modelo **Raspberry - MV** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
